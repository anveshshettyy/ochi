...
export default function Footer() {
    return (
        <div data-scroll data-scroll-section data-scroll-speed=".01" className=' w-full h-screen bg-zinc-300'>
            <div className='w-full flex p-10'>
                <div className='w-1/2 h-[80vh] flex flex-col justify-between'>
                    <div>
                        <h1 className='text-[18.5vh] font-light font-founders-grotesk  leading-none -mb-8'>EYE-</h1>
                        <h1 className='text-[18.5vh] font-founders-grotesk font-black leading-none -mb-8'>OPENING</h1>
                    </div>
                ...
                <div className='w-1/2'>
                    <h1 className='text-[18.5vh] font-light font-founders-grotesk  leading-none -mb-8'>PRESENTATIONS</h1>
                    <h1 className='mt-[5vh]'>S:</h1>
                    <div>{["Instagram", "Behance", "Facebook", "LinkedIn"].map((item, index) =>
                        <h1 className='underline mt-1'>{item}</h1>
                    )}</div>
                    <h1 className='mt-[5vh]'>L:</h1>
                    <div>{["202-1965 W 4th Ave", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"].map((item, index) =>(
                        <h1 className={`underline mt-1 ${index===1 && "mt-20"}`}>{item}</h1>
                    ))}</div>
                </div>
            </div>
        </div>
